// Static reference data: model catalog, categories, currencies, navigation
...
export const NAV_SECTIONS = [
  ...
  },
  {
    label: "Optimise",
    items: [
      { id: "recommendations", icon: "TrendingDown", name: "Recommendations", href: "/recommendations", badge: "5" },
  ...
  },
  {
    label: "Explore",
    items: [
      { id: "quickstart", icon: "Compass", name: "Quickstart", href: "/quickstart" },
