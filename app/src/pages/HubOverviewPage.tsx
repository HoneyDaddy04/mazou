...
import { Check, X, ChevronDown, ChevronRight, ArrowRight } from "lucide-react";
  ...
  return (
    <div className="max-w-4xl mx-auto px-5 py-16">
      ...
      <div className="text-center mb-16">
        <div className="font-mono text-xs uppercase tracking-[0.15em] text-[#00E5A0] mb-4">Deep Dive</div>
        <h1 className="text-[clamp(2rem,5vw,3.5rem)] font-extrabold leading-[1.1] tracking-tight mb-4" style={{ letterSpacing: "-0.03em" }}>
      ...
      {/* Table of contents */}
      <div className="bg-[#F9FAFB] border border-[#E5E7EB] rounded-xl p-6 mb-16">
        <h2 className="text-sm font-semibold uppercase tracking-wider text-[#6B7280] mb-4">Contents</h2>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
          {toc.map((item, i) => (
            <a
              key={item.id}
              href={`#${item.id}`}
              className="flex items-center gap-2 px-3 py-2 rounded-lg text-sm text-[#6B7280] hover:text-[#0A1628] hover:bg-[#E5E7EB] transition-all"
            >
              <span className="font-mono text-xs text-[#00E5A0]">{String(i + 1).padStart(2, "0")}</span>
              {item.label}
            </a>
          ))}
        </div>
      ...
      <Section id="problem" className="mb-20">
        ...
        <div className="prose-custom space-y-4 text-[#6B7280] leading-relaxed">
          <p>
            Across the world, companies are embedding AI into every product &mdash; customer support, fraud detection,
            content generation, data analysis. The AI API market hit <strong className="text-[#0A1628]">$13.3 billion in 2025</strong> and
        ...
        {/* Pain point diagram */}
        <div className="mt-8 bg-[#F9FAFB] border border-[#E5E7EB] rounded-xl p-8">
          <h3 className="text-sm font-semibold uppercase tracking-wider text-[#6B7280] mb-6 text-center">The African Developer Experience Today</h3>
          <div className="flex flex-col items-center gap-4 font-mono text-sm">
            <div className="px-6 py-3 border border-[#0A1628] rounded-lg text-center">African Developer</div>
            <div className="text-[#FF4D4D] flex items-center gap-1"><ChevronDown size={14} /> needs AI</div>
            <div className="grid grid-cols-1 md:grid-cols-4 gap-3 w-full">
              {[
                ...
                <div key={p.provider} className="border border-[#E5E7EB] rounded-lg p-4 text-center">
                  <div className="text-xs text-[#0A1628] mb-2">{p.provider}</div>
                  <div className="text-xs text-[#FF4D4D]">{p.problem}</div>
                </div>
              ))}
            </div>
            <div className="text-[#FF4D4D] text-xs text-center mt-2">
              <span className="inline-flex items-center gap-1"><ChevronDown size={14} /> Result: 4 accounts, 4 dashboards, 4 USD invoices, zero visibility</span>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mt-8">
          <div className="bg-[#F9FAFB] border border-[#E5E7EB] rounded-xl p-6">
            <h3 className="font-semibold text-[#00E5A0] mb-3">The Payment Problem</h3>
      ...
      <Section id="solution" className="mb-20">
        <div className="font-mono text-xs uppercase tracking-[0.15em] text-[#00E5A0] mb-4">02 &mdash; The Solution</div>
        <h2 className="text-3xl font-extrabold mb-6" style={{ letterSpacing: "-0.02em" }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          <div className="bg-[#F9FAFB] border border-[#FF4D4D] border-opacity-30 rounded-xl p-6">
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={item} className="text-sm text-[#6B7280] flex items-start gap-2">
                  <span className="text-[#FF4D4D] shrink-0"><X size={14} /></span> {item}
                </li>
              ))}
            </ul>
          </div>
          <div className="bg-[#F9FAFB] border border-[#00E5A0] border-opacity-30 rounded-xl p-6">
            <div className="text-xs font-mono uppercase tracking-wider text-[#00E5A0] mb-4">After Mazou</div>
            <ul className="space-y-3">
              {[
                ...
                <li key={item} className="text-sm text-[#6B7280] flex items-start gap-2">
                  <span className="text-[#00E5A0] shrink-0"><Check size={14} /></span> {item}
                </li>
              ))}
            </ul>
          </div>
      ...
      <Section id="architecture" className="mb-20">
        <div className="font-mono text-xs uppercase tracking-[0.15em] text-[#00E5A0] mb-4">03 &mdash; Architecture</div>
        <h2 className="text-3xl font-extrabold mb-6" style={{ letterSpacing: "-0.02em" }}>
        ...
        <div className="bg-[#F9FAFB] border border-[#E5E7EB] rounded-xl p-8">
          <h3 className="text-sm font-semibold uppercase tracking-wider text-[#6B7280] mb-6 text-center">System Architecture</h3>
          <div className="flex flex-col items-center gap-4 font-mono text-xs">
            {/* Client layer */}
            <div className="flex gap-3 flex-wrap justify-center">
              <div className="px-4 py-2.5 border border-[#6B7280] rounded-lg">Your Python App</div>
              <div className="px-4 py-2.5 border border-[#6B7280] rounded-lg">Your Node.js App</div>
              <div className="px-4 py-2.5 border border-[#6B7280] rounded-lg">AI Agents</div>
              <div className="px-4 py-2.5 border border-[#6B7280] rounded-lg">No-Code Tools</div>
            </div>
            <div className="text-[#6B7280] flex items-center gap-1 justify-center"><ChevronDown size={14} /> OpenAI-compatible API calls <ChevronDown size={14} /></div>

            {/* Gateway */}
            <div className="w-full max-w-lg border-2 border-[#00E5A0] rounded-xl p-5 text-center">
              <div className="text-base font-semibold text-[#00E5A0] mb-3">Mazou Gateway</div>
              <div className="grid grid-cols-4 gap-2">
                <div className="bg-white rounded-lg p-2 text-[10px]">
                  <div className="text-[#00E5A0] font-semibold mb-1">Auth</div>
                  API keys, JWT
                </div>
                <div className="bg-white rounded-lg p-2 text-[10px]">
                  <div className="text-[#00E5A0] font-semibold mb-1">Router</div>
                  Model selection
                </div>
                <div className="bg-white rounded-lg p-2 text-[10px]">
            ...
            <div className="flex gap-3 flex-wrap justify-center">
              {[
                ...
                { name: "Mistral", color: "#F43F5E" },
                { name: "African AI", color: "#00E5A0" },
              ].map((p) => (
            ...
            <div className="text-[#6B7280] mt-2"><ChevronDown size={14} /></div>

            {/* Data stores */}
            <div className="flex gap-3">
              <div className="px-4 py-2.5 bg-[#E5E7EB] border border-[#E5E7EB] rounded-lg">PostgreSQL</div>
              <div className="px-4 py-2.5 bg-[#E5E7EB] border border-[#E5E7EB] rounded-lg">Redis Cache</div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mt-8">
          <div className="bg-[#F9FAFB] border border-[#E5E7EB] rounded-xl p-6">
            ...
            <ul className="space-y-2 text-sm text-[#6B7280]">
              <li><strong className="text-[#0A1628]">FastAPI</strong> &mdash; async Python, 30 API endpoints</li>
              <li><strong className="text-[#0A1628]">LiteLLM</strong> &mdash; embedded multi-provider abstraction</li>
              <li><strong className="text-[#0A1628]">SQLAlchemy</strong> &mdash; 12 data models, Alembic migrations</li>
              <li><strong className="text-[#0A1628]">Atomic wallet</strong> &mdash; UPDATE WHERE balance &gt;= amount</li>
            </ul>
          </div>
          <div className="bg-[#F9FAFB] border border-[#E5E7EB] rounded-xl p-6">
            <h3 className="font-semibold text-sm mb-3">Frontend</h3>
            <ul className="space-y-2 text-sm text-[#6B7280]">
              <li><strong className="text-[#0A1628]">Next.js 16</strong> &mdash; React 19, App Router</li>
              <li><strong className="text-[#0A1628]">Tailwind v4</strong> &mdash; custom design system</li>
              <li><strong className="text-[#0A1628]">SWR + Zustand</strong> &mdash; data fetching &amp; state</li>
              <li><strong className="text-[#0A1628]">Recharts</strong> &mdash; spend visualization</li>
            </ul>
          </div>
        </div>
      </Section>
      ...
      <Section id="routing" className="mb-20">
        <div className="font-mono text-xs uppercase tracking-[0.15em] text-[#00E5A0] mb-4">04 &mdash; Smart Routing</div>
        <h2 className="text-3xl font-extrabold mb-6" style={{ letterSpacing: "-0.02em" }}>
          The right model for every request.
        </h2>
        <p className="text-[#6B7280] leading-relaxed mb-8">
          Instead of hard-coding a model, developers send <code className="text-[#3B82F6] bg-[#F9FAFB] px-1.5 py-0.5 rounded text-xs">model=&quot;auto&quot;</code> and
        ...
        <div className="space-y-5">
          {[
            ...
            <div key={strategy.title} className="bg-[#F9FAFB] border border-[#E5E7EB] rounded-xl p-6">
              <h3 className="font-semibold mb-2" style={{ color: strategy.color }}>{strategy.title}</h3>
              <p className="text-sm text-[#6B7280] leading-relaxed mb-3">{strategy.desc}</p>
              <div className="bg-white rounded-lg px-4 py-3 font-mono text-xs text-[#6B7280]">
                {strategy.example}
              </div>
            </div>
          ))}
        ...
        {/* Savings diagram */}
        <div className="bg-[#F9FAFB] border border-[#E5E7EB] rounded-xl p-8 mt-8">
          <h3 className="text-sm font-semibold uppercase tracking-wider text-[#6B7280] mb-6 text-center">Cost Savings Example</h3>
          <div className="space-y-4 max-w-lg mx-auto">
            {[
              ...
              <div key={row.feature} className="bg-white rounded-lg p-4">
                <div className="flex justify-between items-baseline mb-2">
                  <span className="text-sm font-medium">{row.feature}</span>
                  <span className="font-mono text-sm text-[#3B82F6]">-{row.pct}%</span>
                </div>
                <div className="text-xs text-[#6B7280] flex justify-between mb-2">
                  <span>{row.before}</span>
                  <span><ArrowRight size={14} /></span>
                  <span className="text-[#3B82F6]">{row.after}</span>
                </div>
                <div className="h-1.5 bg-[#E5E7EB] rounded-full overflow-hidden">
                  <div className="h-full bg-[#3B82F6] rounded-full" style={{ width: `${100 - row.pct}%` }} />
                </div>
              </div>
            ))}
          </div>
      ...
      <Section id="billing" className="mb-20">
        <div className="font-mono text-xs uppercase tracking-[0.15em] text-[#00E5A0] mb-4">05 &mdash; Billing Flow</div>
        <h2 className="text-3xl font-extrabold mb-6" style={{ letterSpacing: "-0.02em" }}>
        ...
        <div className="bg-[#F9FAFB] border border-[#E5E7EB] rounded-xl p-8">
          <h3 className="text-sm font-semibold uppercase tracking-wider text-[#6B7280] mb-6 text-center">Money Flow</h3>
          <div className="flex flex-col items-center gap-4 font-mono text-xs max-w-md mx-auto">
            {[
              { step: "1", label: "User funds wallet", detail: "Paystack (bank transfer, card, USSD)", color: "#00E5A0" },
              { step: "2", label: "Webhook confirms payment", detail: "HMAC-SHA512 verified", color: "#00E5A0" },
              { step: "3", label: "Wallet credited", detail: "Balance += amount (atomic)", color: "#00E5A0" },
              ...
              { step: "6", label: "Wallet debited atomically", detail: "UPDATE WHERE balance >= cost", color: "#00E5A0" },
              ...
              <div key={s.step} className="flex items-center gap-4 w-full">
                ...
                <div className="flex-1 bg-white rounded-lg px-4 py-3">
                  <div className="text-sm text-[#0A1628] mb-0.5 font-sans">{s.label}</div>
                  <div className="text-[10px] text-[#6B7280]">{s.detail}</div>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="bg-white border border-[#00E5A0] rounded-xl p-5 text-center mt-6">
      ...
      <Section id="dashboard" className="mb-20">
        <div className="font-mono text-xs uppercase tracking-[0.15em] text-[#00E5A0] mb-4">06 &mdash; Dashboard</div>
        <h2 className="text-3xl font-extrabold mb-6" style={{ letterSpacing: "-0.02em" }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          {[
            { title: "Spend by Feature", desc: "Tag every API call with a feature name. See exactly how much your support bot, fraud detector, and search engine each cost.", color: "#00E5A0" },
            { title: "Spend by Agent", desc: "Track individual AI agents -- their request volume, cost per action, and trend over time. Identify expensive agents before they drain wallets.", color: "#00E5A0" },
            ...
            <div key={card.title} className="bg-[#F9FAFB] border border-[#E5E7EB] rounded-xl p-6">
      ...
      <Section id="models" className="mb-20">
        <div className="font-mono text-xs uppercase tracking-[0.15em] text-[#00E5A0] mb-4">07 &mdash; Models</div>
        <h2 className="text-3xl font-extrabold mb-6" style={{ letterSpacing: "-0.02em" }}>
          ...
          <div className="bg-[#F9FAFB] border border-[#E5E7EB] rounded-xl p-6">
            ...
            <div className="flex flex-wrap gap-2">
              {["GPT-5.2", "GPT-5", "GPT-4o", "Claude Opus 4.6", "Claude Sonnet 4.6", "Claude Haiku", "Gemini 2.5 Pro", "Gemini 2.5 Flash", "DeepSeek R1", "DeepSeek V3", "Llama 4 Maverick", "Mistral Large", "Cohere Command R+"].map((m) => (
                <span key={m} className="px-3 py-1.5 bg-[#E5E7EB] border border-[#E5E7EB] rounded-full text-xs">{m}</span>
              ))}
            </div>
          </div>
          <div className="bg-[#F9FAFB] border border-[#00E5A0] border-opacity-30 rounded-xl p-6">
            <h3 className="font-semibold text-sm text-[#00E5A0] mb-4">African Language Models</h3>
            <div className="flex flex-wrap gap-2">
              {[
                ...
                <span key={m.name} className="px-3 py-1.5 border border-[#00E5A0] text-[#00E5A0] bg-[rgba(0,229,160,0.08)] rounded-full text-xs" title={m.lang}>
                  {m.name}
                </span>
              ))}
            </div>
      ...
      <Section id="why-africa" className="mb-20">
        <div className="font-mono text-xs uppercase tracking-[0.15em] text-[#00E5A0] mb-4">08 &mdash; Why Africa</div>
        <h2 className="text-3xl font-extrabold mb-6" style={{ letterSpacing: "-0.02em" }}>
          The analogy that matters.
        </h2>
        <div className="bg-[#F9FAFB] border border-[#E5E7EB] rounded-xl p-8 mb-8">
          <div className="max-w-xl mx-auto text-center">
            ...
            <p className="text-xl font-semibold text-[#00E5A0] leading-relaxed">
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-[#E5E7EB]">
                  <th className="text-left p-3 text-xs uppercase tracking-wider text-[#6B7280] font-semibold" />
                  <th className="text-left p-3 text-xs uppercase tracking-wider text-[#6B7280] font-semibold">2015 &mdash; Payments</th>
                  <th className="text-left p-3 text-xs uppercase tracking-wider text-[#3B82F6] font-semibold">2026 &mdash; AI</th>
                </tr>
              </thead>
              <tbody className="text-[#6B7280]">
                {[
                  ...
                  <tr key={row.label} className="border-b border-[#E5E7EB]">
                    <td className="p-3 font-medium text-[#0A1628]">{row.label}</td>
                    <td className="p-3">{row.payments}</td>
                    <td className="p-3 text-[#3B82F6]">{row.ai}</td>
                  </tr>
                ))}
              </tbody>
            </table>
      ...
      {/* Footer CTA */}
      <div className="text-center py-16 border-t border-[#E5E7EB]">
        <p className="text-xl font-semibold mb-4">Want to learn more?</p>
        <div className="flex gap-4 justify-center">
          <a href="/hub/pitch" className="bg-[#00E5A0] text-[#0A1628] px-6 py-3 rounded-lg font-semibold text-sm hover:bg-[#00cc8e] transition-all">
            View Pitch Deck
          </a>
          <a href="/hub/faq" className="bg-[#F9FAFB] border border-[#E5E7EB] text-[#0A1628] px-6 py-3 rounded-lg font-semibold text-sm hover:border-[#6B7280] transition-all">
            Investor FAQ
          </a>
        </div>
      </div>
