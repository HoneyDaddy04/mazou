  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-4 gap-2.5 mb-5">
        ...
        <StatCard label="African Models" value={`${africanCount}`} change="Language, Healthcare, AgriTech, FinTech" color="#FFB800" />
          ...
          return (
            ...
            >
              ...
              <div className="flex items-center justify-between mb-2">
                ...
                {m.isAfrican && (
                  <Badge color="#FFB800" bg="rgba(255,184,0,0.1)">African</Badge>
                )}
              </div>

              {/* Category + Tags */}
              <div className="flex items-center gap-1 mb-2 flex-wrap">
                <span className="text-[9px] px-1.5 py-0.5 bg-[rgba(0,210,106,0.08)] text-accent rounded font-medium">
                  {m.category}
                </span>
              ...
              {m.africanMeta?.domain && m.africanMeta.domain !== "Language" && (
                <div className="mt-2 text-[9px] px-1.5 py-0.5 bg-[rgba(255,184,0,0.08)] text-naira rounded inline-block font-medium">
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center justify-between gap-3">
          ...
          <div className="flex gap-2 shrink-0">
            <button
              onClick={onActivate}
              className="bg-accent text-black px-4 py-2 rounded-lg text-xs font-semibold cursor-pointer hover:brightness-110 transition-all"
            >
              Activate Model
            </button>
            <button
        ...
        <div className="flex gap-1 flex-wrap">
          <span className="text-[10px] px-2 py-0.5 bg-[rgba(0,210,106,0.08)] text-accent rounded-full font-semibold">
            {m.category}
          </span>
          {m.tags.map((t) => (
          ...
          {m.isAfrican && (
            <span className="text-[10px] px-2 py-0.5 bg-[rgba(255,184,0,0.1)] text-naira rounded-full font-semibold">
              African
            </span>
          )}
        </div>
        ...
        {/* African metadata */}
        {m.africanMeta && (
          <div className="bg-[rgba(255,184,0,0.04)] border border-[rgba(255,184,0,0.15)] rounded-lg p-3">
            ...
            <div className="flex gap-1 flex-wrap mt-2">
              {m.africanMeta.langs.map((l, i) => (
                <span key={i} className="text-[9px] px-1.5 py-0.5 bg-[rgba(255,184,0,0.08)] text-naira rounded font-mono">
                  {l}
                </span>
              ))}
            </div>
